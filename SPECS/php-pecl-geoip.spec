...
%changelog
* Tue Jan 02 2018 Alexander Ursu <alexander.ursu@gmail.com> - 1.1.1-3
- added suport of CentOS 6 (based on spec file for memcache extension)

* Fri Dec 15 2017 Alexander Ursu <alexander.ursu@gmail.com> - 1.1.1-2
- rebuild for HS environment (due to wrong dependency resolution)
